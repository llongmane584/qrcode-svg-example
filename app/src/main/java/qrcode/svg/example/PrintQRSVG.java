...
public class PrintQRSVG {
    ...
    public void write() throws Exception {
        ...
        svgText.append(renderQRImage(code, canvasSize, quietZoneSize, circleDiameterRatio));
        svgText.append("</svg>");
     ...
     */
    private StringBuilder renderQRImage(QRCode code, int canvasSize, int quietZone, float circleDiameterRatio) {
